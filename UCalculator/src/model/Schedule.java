...
/**
 * Schedule é a classe responsável por representar uma agenda organizada por dias e dividida em slots.
 */
class Schedule implements Serializable {
    ...
    Task removeTask(final LocalDate date, final int slotId) {
        ...
        if (slotId + startSlotId >= startSlotId && startSlotId + slotId <= endSlotId) {
            ...
            if (slots != null && (slot = slots.get(slotId + startSlotId)).getClass().equals(BusySlot.class)) {
                ...
                int k = task.getSlotId() + startSlotId;
     ...
     * Se não for possível definir na hora especificada, o slot imediatamente anterior
     * será o especificado para a nova hora de início.
     *
     ...
     * Se não for possível definir na hora especificada, o slot imediatamente posterior
     * será o especificado para a nova hora de fim.
     *
